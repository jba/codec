...
func (c ptr_LicenseData_codec) encode(e *codecapi.Encoder, x *LicenseData) {
...
func (c ptr_LicenseData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *LicenseData
	c.decode(d, &x)
	return x
}

func (c ptr_LicenseData_codec) decode(d *codecapi.Decoder, p **LicenseData) {
...
func (c LicenseData_codec) encode(e *codecapi.Encoder, x *LicenseData) {
	e.StartStruct()
	if x.Files != nil {
		e.EncodeUint(0)
...
func (c LicenseData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x LicenseData
	c.decode(d, &x)
	return x
}

func (c LicenseData_codec) decode(d *codecapi.Decoder, x *LicenseData) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(LicenseData{}, LicenseData_codec{})
	codecapi.Register(&LicenseData{}, ptr_LicenseData_codec{})
}
...
func (c submittedData_codec) encode(e *codecapi.Encoder, m submittedData) {
	if m == nil {
		e.EncodeNil()
		return
	}
...
func (c submittedData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x submittedData
	c.decode(d, &x)
	return x
}

func (c submittedData_codec) decode(d *codecapi.Decoder, p *submittedData) {
	n2 := d.StartList()
	if n2 < 0 {
		return
	}
...
func init() { codecapi.Register(submittedData(nil), submittedData_codec{}) }
...
func (c slice_ptr_StockData_codec) encode(e *codecapi.Encoder, s []*StockData) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_StockData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*StockData
	c.decode(d, &x)
	return x
}

func (c slice_ptr_StockData_codec) decode(d *codecapi.Decoder, p *[]*StockData) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*StockData(nil), slice_ptr_StockData_codec{})
}
...
func (c slice_Score_codec) encode(e *codecapi.Encoder, s []Score) {
	...
	e.StartList(len(s))
	for _, x := range s {
		(Score_codec{}).encode(e, &x)
	}
}

func (c slice_Score_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []Score
	c.decode(d, &x)
	return x
}

func (c slice_Score_codec) decode(d *codecapi.Decoder, p *[]Score) {
	n := d.StartList()
	if n < 0 {
		return
	}
	s := make([]Score, n)
	for i := 0; i < n; i++ {
		(Score_codec{}).decode(d, &s[i])
	}
	*p = s
}

func init() {
	codecapi.Register([]Score(nil), slice_Score_codec{})
}
...
func (c slice_ptr_LicenseFile_codec) encode(e *codecapi.Encoder, s []*LicenseFile) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_LicenseFile_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*LicenseFile
	c.decode(d, &x)
	return x
}

func (c slice_ptr_LicenseFile_codec) decode(d *codecapi.Decoder, p *[]*LicenseFile) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*LicenseFile(nil), slice_ptr_LicenseFile_codec{})
}
...
func (c slice_ptr_LicenseContents_codec) encode(e *codecapi.Encoder, s []*LicenseContents) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_LicenseContents_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*LicenseContents
	c.decode(d, &x)
	return x
}

func (c slice_ptr_LicenseContents_codec) decode(d *codecapi.Decoder, p *[]*LicenseContents) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*LicenseContents(nil), slice_ptr_LicenseContents_codec{})
}
...
func (c ptr_submittedLedgerData_codec) encode(e *codecapi.Encoder, x *submittedLedgerData) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_submittedLedgerData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *submittedLedgerData
	c.decode(d, &x)
	return x
}

func (c ptr_submittedLedgerData_codec) decode(d *codecapi.Decoder, p **submittedLedgerData) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c submittedLedgerData_codec) encode(e *codecapi.Encoder, x *submittedLedgerData) {
	e.StartStruct()
	if x.Blocks != nil {
		e.EncodeUint(0)
...
func (c submittedLedgerData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x submittedLedgerData
	c.decode(d, &x)
	return x
}

func (c submittedLedgerData_codec) decode(d *codecapi.Decoder, x *submittedLedgerData) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(submittedLedgerData{}, submittedLedgerData_codec{})
	codecapi.Register(&submittedLedgerData{}, ptr_submittedLedgerData_codec{})
}
...
// Fields of Score: GameID PlayerID Scores
...
func (c ptr_Score_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *Score
	c.decode(d, &x)
	return x
}

func (c ptr_Score_codec) decode(d *codecapi.Decoder, p **Score) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c Score_codec) encode(e *codecapi.Encoder, x *Score) {
	e.StartStruct()
	if x.GameID != 0 {
		e.EncodeUint(0)
		e.EncodeInt(int64(x.GameID))
	}
	if x.PlayerID != 0 {
		e.EncodeUint(1)
		e.EncodeInt(int64(x.PlayerID))
	}
	if x.Scores != nil {
		e.EncodeUint(2)
		(slice_int_codec{}).encode(e, x.Scores)
	}
	e.EndStruct()
}

func (c Score_codec) Decode(d *codecapi.Decoder) interface{} {
	var x Score
	c.decode(d, &x)
	return x
}

func (c Score_codec) decode(d *codecapi.Decoder, x *Score) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
		...
		switch n {
		case 0:
			x.GameID = int(d.DecodeInt())
		case 1:
			x.PlayerID = int(d.DecodeInt())
		case 2:
			(slice_int_codec{}).decode(d, &x.Scores)
		default:
			d.UnknownField("Score", n)
		}
	}
}

func init() {
	codecapi.Register(Score{}, Score_codec{})
	codecapi.Register(&Score{}, ptr_Score_codec{})
}
...
func (c ptr_LicenseFile_codec) encode(e *codecapi.Encoder, x *LicenseFile) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_LicenseFile_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *LicenseFile
	c.decode(d, &x)
	return x
}

func (c ptr_LicenseFile_codec) decode(d *codecapi.Decoder, p **LicenseFile) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c LicenseFile_codec) encode(e *codecapi.Encoder, x *LicenseFile) {
	e.StartStruct()
	if x.Module != "" {
		e.EncodeUint(0)
...
func (c LicenseFile_codec) Decode(d *codecapi.Decoder) interface{} {
	var x LicenseFile
	c.decode(d, &x)
	return x
}

func (c LicenseFile_codec) decode(d *codecapi.Decoder, x *LicenseFile) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(LicenseFile{}, LicenseFile_codec{})
	codecapi.Register(&LicenseFile{}, ptr_LicenseFile_codec{})
}
...
func (c ptr_LicenseContents_codec) encode(e *codecapi.Encoder, x *LicenseContents) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_LicenseContents_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *LicenseContents
	c.decode(d, &x)
	return x
}

func (c ptr_LicenseContents_codec) decode(d *codecapi.Decoder, p **LicenseContents) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c LicenseContents_codec) encode(e *codecapi.Encoder, x *LicenseContents) {
	e.StartStruct()
	if x.Contents != nil {
		e.EncodeUint(0)
...
func (c LicenseContents_codec) Decode(d *codecapi.Decoder) interface{} {
	var x LicenseContents
	c.decode(d, &x)
	return x
}

func (c LicenseContents_codec) decode(d *codecapi.Decoder, x *LicenseContents) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(LicenseContents{}, LicenseContents_codec{})
	codecapi.Register(&LicenseContents{}, ptr_LicenseContents_codec{})
}
...
func (c slice_ptr_BlockAndPvtData_codec) encode(e *codecapi.Encoder, s []*BlockAndPvtData) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_BlockAndPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*BlockAndPvtData
	c.decode(d, &x)
	return x
}

func (c slice_ptr_BlockAndPvtData_codec) decode(d *codecapi.Decoder, p *[]*BlockAndPvtData) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*BlockAndPvtData(nil), slice_ptr_BlockAndPvtData_codec{})
}
...
func (c slice_ptr_txAndPvtdata_codec) encode(e *codecapi.Encoder, s []*txAndPvtdata) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_txAndPvtdata_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*txAndPvtdata
	c.decode(d, &x)
	return x
}

func (c slice_ptr_txAndPvtdata_codec) decode(d *codecapi.Decoder, p *[]*txAndPvtdata) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*txAndPvtdata(nil), slice_ptr_txAndPvtdata_codec{})
}
...
func (c array_32_uint8_codec) encode(e *codecapi.Encoder, s *[32]uint8) {
	e.EncodeBytes((*s)[:])
}

func (c array_32_uint8_codec) Decode(d *codecapi.Decoder) interface{} {
	var x [32]uint8
	c.decode(d, &x)
	return x
}

func (c array_32_uint8_codec) decode(d *codecapi.Decoder, p *[32]uint8) {
	b := d.DecodeBytes()
	copy((*p)[:], b)
}

func init() {
	codecapi.Register([32]uint8{}, array_32_uint8_codec{})
}
...
func (c slice_string_codec) encode(e *codecapi.Encoder, s []string) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_string_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []string
	c.decode(d, &x)
	return x
}

func (c slice_string_codec) decode(d *codecapi.Decoder, p *[]string) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]string(nil), slice_string_codec{})
}
...
func (c ptr_licensecheck_Coverage_codec) encode(e *codecapi.Encoder, x *licensecheck.Coverage) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_licensecheck_Coverage_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *licensecheck.Coverage
	c.decode(d, &x)
	return x
}

func (c ptr_licensecheck_Coverage_codec) decode(d *codecapi.Decoder, p **licensecheck.Coverage) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c licensecheck_Coverage_codec) encode(e *codecapi.Encoder, x *licensecheck.Coverage) {
	e.StartStruct()
	if x.Percent != 0 {
		e.EncodeUint(0)
...
func (c licensecheck_Coverage_codec) Decode(d *codecapi.Decoder) interface{} {
	var x licensecheck.Coverage
	c.decode(d, &x)
	return x
}

func (c licensecheck_Coverage_codec) decode(d *codecapi.Decoder, x *licensecheck.Coverage) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(licensecheck.Coverage{}, licensecheck_Coverage_codec{})
	codecapi.Register(&licensecheck.Coverage{}, ptr_licensecheck_Coverage_codec{})
}
...
func (c ptr_BlockAndPvtData_codec) encode(e *codecapi.Encoder, x *BlockAndPvtData) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_BlockAndPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *BlockAndPvtData
	c.decode(d, &x)
	return x
}

func (c ptr_BlockAndPvtData_codec) decode(d *codecapi.Decoder, p **BlockAndPvtData) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c BlockAndPvtData_codec) encode(e *codecapi.Encoder, x *BlockAndPvtData) {
	e.StartStruct()
	if x.Block != nil {
		e.EncodeUint(0)
...
func (c BlockAndPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x BlockAndPvtData
	c.decode(d, &x)
	return x
}

func (c BlockAndPvtData_codec) decode(d *codecapi.Decoder, x *BlockAndPvtData) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(BlockAndPvtData{}, BlockAndPvtData_codec{})
	codecapi.Register(&BlockAndPvtData{}, ptr_BlockAndPvtData_codec{})
}
...
func (c ptr_txAndPvtdata_codec) encode(e *codecapi.Encoder, x *txAndPvtdata) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_txAndPvtdata_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *txAndPvtdata
	c.decode(d, &x)
	return x
}

func (c ptr_txAndPvtdata_codec) decode(d *codecapi.Decoder, p **txAndPvtdata) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c txAndPvtdata_codec) encode(e *codecapi.Encoder, x *txAndPvtdata) {
	e.StartStruct()
	if x.Txid != "" {
		e.EncodeUint(0)
...
func (c txAndPvtdata_codec) Decode(d *codecapi.Decoder) interface{} {
	var x txAndPvtdata
	c.decode(d, &x)
	return x
}

func (c txAndPvtdata_codec) decode(d *codecapi.Decoder, x *txAndPvtdata) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(txAndPvtdata{}, txAndPvtdata_codec{})
	codecapi.Register(&txAndPvtdata{}, ptr_txAndPvtdata_codec{})
}
...
func (c slice_licensecheck_Match_codec) encode(e *codecapi.Encoder, s []licensecheck.Match) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_licensecheck_Match_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []licensecheck.Match
	c.decode(d, &x)
	return x
}

func (c slice_licensecheck_Match_codec) decode(d *codecapi.Decoder, p *[]licensecheck.Match) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]licensecheck.Match(nil), slice_licensecheck_Match_codec{})
}
...
func (c ptr_Block_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *Block
	c.decode(d, &x)
	return x
}

func (c ptr_Block_codec) decode(d *codecapi.Decoder, p **Block) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c Block_codec) encode(e *codecapi.Encoder, x *Block) {
	e.StartStruct()
	if x.Header != nil {
		e.EncodeUint(0)
...
func (c Block_codec) Decode(d *codecapi.Decoder) interface{} {
	var x Block
	c.decode(d, &x)
	return x
}

func (c Block_codec) decode(d *codecapi.Decoder, x *Block) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(Block{}, Block_codec{})
	codecapi.Register(&Block{}, ptr_Block_codec{})
}
...
func (c TxPvtDataMap_codec) Decode(d *codecapi.Decoder) interface{} {
	var x TxPvtDataMap
	c.decode(d, &x)
	return x
}

func (c TxPvtDataMap_codec) decode(d *codecapi.Decoder, p *TxPvtDataMap) {
	n2 := d.StartList()
	if n2 < 0 {
		return
	}
...
func (c TxMissingPvtData_codec) encode(e *codecapi.Encoder, m TxMissingPvtData) {
	if m == nil {
		e.EncodeNil()
		return
	}
...
func (c TxMissingPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x TxMissingPvtData
	c.decode(d, &x)
	return x
}

func (c TxMissingPvtData_codec) decode(d *codecapi.Decoder, p *TxMissingPvtData) {
	n2 := d.StartList()
	if n2 < 0 {
		return
	}
...
func init() { codecapi.Register(TxMissingPvtData(nil), TxMissingPvtData_codec{}) }
...
func (c ptr_Envelope_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *Envelope
	c.decode(d, &x)
	return x
}

func (c ptr_Envelope_codec) decode(d *codecapi.Decoder, p **Envelope) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c Envelope_codec) encode(e *codecapi.Encoder, x *Envelope) {
	e.StartStruct()
	if x.Payload != nil {
		e.EncodeUint(0)
...
func (c Envelope_codec) Decode(d *codecapi.Decoder) interface{} {
	var x Envelope
	c.decode(d, &x)
	return x
}

func (c Envelope_codec) decode(d *codecapi.Decoder, x *Envelope) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(Envelope{}, Envelope_codec{})
	codecapi.Register(&Envelope{}, ptr_Envelope_codec{})
}
...
func (c ptr_TxPvtReadWriteSet_codec) encode(e *codecapi.Encoder, x *TxPvtReadWriteSet) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_TxPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *TxPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c ptr_TxPvtReadWriteSet_codec) decode(d *codecapi.Decoder, p **TxPvtReadWriteSet) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c TxPvtReadWriteSet_codec) encode(e *codecapi.Encoder, x *TxPvtReadWriteSet) {
	e.StartStruct()
	if x.DataModel != 0 {
		e.EncodeUint(0)
...
func (c TxPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x TxPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c TxPvtReadWriteSet_codec) decode(d *codecapi.Decoder, x *TxPvtReadWriteSet) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(TxPvtReadWriteSet{}, TxPvtReadWriteSet_codec{})
	codecapi.Register(&TxPvtReadWriteSet{}, ptr_TxPvtReadWriteSet_codec{})
}
...
func (c ptr_licensecheck_Match_codec) encode(e *codecapi.Encoder, x *licensecheck.Match) {
	if !e.StartPtr(x == nil, x) {
		return
	}
	(licensecheck_Match_codec{}).encode(e, x)
...
func (c ptr_licensecheck_Match_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *licensecheck.Match
	c.decode(d, &x)
	return x
}

func (c ptr_licensecheck_Match_codec) decode(d *codecapi.Decoder, p **licensecheck.Match) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c licensecheck_Match_codec) Decode(d *codecapi.Decoder) interface{} {
	var x licensecheck.Match
	c.decode(d, &x)
	return x
}

func (c licensecheck_Match_codec) decode(d *codecapi.Decoder, x *licensecheck.Match) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(licensecheck.Match{}, licensecheck_Match_codec{})
	codecapi.Register(&licensecheck.Match{}, ptr_licensecheck_Match_codec{})
}
...
func (c ptr_BlockHeader_codec) encode(e *codecapi.Encoder, x *BlockHeader) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_BlockHeader_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *BlockHeader
	c.decode(d, &x)
	return x
}

func (c ptr_BlockHeader_codec) decode(d *codecapi.Decoder, p **BlockHeader) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c BlockHeader_codec) encode(e *codecapi.Encoder, x *BlockHeader) {
	e.StartStruct()
	if x.Number != 0 {
		e.EncodeUint(0)
...
func (c BlockHeader_codec) Decode(d *codecapi.Decoder) interface{} {
	var x BlockHeader
	c.decode(d, &x)
	return x
}

func (c BlockHeader_codec) decode(d *codecapi.Decoder, x *BlockHeader) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(BlockHeader{}, BlockHeader_codec{})
	codecapi.Register(&BlockHeader{}, ptr_BlockHeader_codec{})
}
...
func (c ptr_BlockData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *BlockData
	c.decode(d, &x)
	return x
}

func (c ptr_BlockData_codec) decode(d *codecapi.Decoder, p **BlockData) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c BlockData_codec) encode(e *codecapi.Encoder, x *BlockData) {
	e.StartStruct()
	if x.Data != nil {
		e.EncodeUint(0)
...
func (c BlockData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x BlockData
	c.decode(d, &x)
	return x
}

func (c BlockData_codec) decode(d *codecapi.Decoder, x *BlockData) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(BlockData{}, BlockData_codec{})
	codecapi.Register(&BlockData{}, ptr_BlockData_codec{})
}
...
func (c ptr_BlockMetadata_codec) encode(e *codecapi.Encoder, x *BlockMetadata) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_BlockMetadata_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *BlockMetadata
	c.decode(d, &x)
	return x
}

func (c ptr_BlockMetadata_codec) decode(d *codecapi.Decoder, p **BlockMetadata) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c BlockMetadata_codec) encode(e *codecapi.Encoder, x *BlockMetadata) {
	e.StartStruct()
	if x.Metadata != nil {
		e.EncodeUint(0)
...
func (c BlockMetadata_codec) Decode(d *codecapi.Decoder) interface{} {
	var x BlockMetadata
	c.decode(d, &x)
	return x
}

func (c BlockMetadata_codec) decode(d *codecapi.Decoder, x *BlockMetadata) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(BlockMetadata{}, BlockMetadata_codec{})
	codecapi.Register(&BlockMetadata{}, ptr_BlockMetadata_codec{})
}
...
func (c ptr_TxPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *TxPvtData
	c.decode(d, &x)
	return x
}

func (c ptr_TxPvtData_codec) decode(d *codecapi.Decoder, p **TxPvtData) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c TxPvtData_codec) encode(e *codecapi.Encoder, x *TxPvtData) {
	e.StartStruct()
	if x.SeqInBlock != 0 {
		e.EncodeUint(0)
...
func (c TxPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x TxPvtData
	c.decode(d, &x)
	return x
}

func (c TxPvtData_codec) decode(d *codecapi.Decoder, x *TxPvtData) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(TxPvtData{}, TxPvtData_codec{})
	codecapi.Register(&TxPvtData{}, ptr_TxPvtData_codec{})
}
...
func (c slice_ptr_MissingPvtData_codec) encode(e *codecapi.Encoder, s []*MissingPvtData) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_MissingPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*MissingPvtData
	c.decode(d, &x)
	return x
}

func (c slice_ptr_MissingPvtData_codec) decode(d *codecapi.Decoder, p *[]*MissingPvtData) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*MissingPvtData(nil), slice_ptr_MissingPvtData_codec{})
}
...
func (c slice_ptr_NsPvtReadWriteSet_codec) encode(e *codecapi.Encoder, s []*NsPvtReadWriteSet) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_NsPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*NsPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c slice_ptr_NsPvtReadWriteSet_codec) decode(d *codecapi.Decoder, p *[]*NsPvtReadWriteSet) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*NsPvtReadWriteSet(nil), slice_ptr_NsPvtReadWriteSet_codec{})
}
...
func (c slice_slice_uint8_codec) encode(e *codecapi.Encoder, s [][]uint8) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_slice_uint8_codec) Decode(d *codecapi.Decoder) interface{} {
	var x [][]uint8
	c.decode(d, &x)
	return x
}

func (c slice_slice_uint8_codec) decode(d *codecapi.Decoder, p *[][]uint8) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([][]uint8(nil), slice_slice_uint8_codec{})
}
...
func (c ptr_MissingPvtData_codec) encode(e *codecapi.Encoder, x *MissingPvtData) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_MissingPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *MissingPvtData
	c.decode(d, &x)
	return x
}

func (c ptr_MissingPvtData_codec) decode(d *codecapi.Decoder, p **MissingPvtData) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c MissingPvtData_codec) encode(e *codecapi.Encoder, x *MissingPvtData) {
	e.StartStruct()
	if x.Namespace != "" {
		e.EncodeUint(0)
...
func (c MissingPvtData_codec) Decode(d *codecapi.Decoder) interface{} {
	var x MissingPvtData
	c.decode(d, &x)
	return x
}

func (c MissingPvtData_codec) decode(d *codecapi.Decoder, x *MissingPvtData) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(MissingPvtData{}, MissingPvtData_codec{})
	codecapi.Register(&MissingPvtData{}, ptr_MissingPvtData_codec{})
}
...
func (c ptr_NsPvtReadWriteSet_codec) encode(e *codecapi.Encoder, x *NsPvtReadWriteSet) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_NsPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *NsPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c ptr_NsPvtReadWriteSet_codec) decode(d *codecapi.Decoder, p **NsPvtReadWriteSet) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c NsPvtReadWriteSet_codec) encode(e *codecapi.Encoder, x *NsPvtReadWriteSet) {
	e.StartStruct()
	if x.Namespace != "" {
		e.EncodeUint(0)
		e.EncodeString(x.Namespace)
...
func (c NsPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x NsPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c NsPvtReadWriteSet_codec) decode(d *codecapi.Decoder, x *NsPvtReadWriteSet) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(NsPvtReadWriteSet{}, NsPvtReadWriteSet_codec{})
	codecapi.Register(&NsPvtReadWriteSet{}, ptr_NsPvtReadWriteSet_codec{})
}
...
func (c slice_ptr_CollectionPvtReadWriteSet_codec) encode(e *codecapi.Encoder, s []*CollectionPvtReadWriteSet) {
	if s == nil {
		e.EncodeNil()
		return
	}
...
func (c slice_ptr_CollectionPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x []*CollectionPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c slice_ptr_CollectionPvtReadWriteSet_codec) decode(d *codecapi.Decoder, p *[]*CollectionPvtReadWriteSet) {
	n := d.StartList()
	if n < 0 {
		return
	}
...
func init() {
	codecapi.Register([]*CollectionPvtReadWriteSet(nil), slice_ptr_CollectionPvtReadWriteSet_codec{})
}
...
func (c ptr_CollectionPvtReadWriteSet_codec) encode(e *codecapi.Encoder, x *CollectionPvtReadWriteSet) {
	if !e.StartPtr(x == nil, x) {
		return
	}
...
func (c ptr_CollectionPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x *CollectionPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c ptr_CollectionPvtReadWriteSet_codec) decode(d *codecapi.Decoder, p **CollectionPvtReadWriteSet) {
	proceed, ref := d.StartPtr()
	if !proceed {
		return
	}
...
func (c CollectionPvtReadWriteSet_codec) encode(e *codecapi.Encoder, x *CollectionPvtReadWriteSet) {
	e.StartStruct()
	if x.CollectionName != "" {
		e.EncodeUint(0)
...
func (c CollectionPvtReadWriteSet_codec) Decode(d *codecapi.Decoder) interface{} {
	var x CollectionPvtReadWriteSet
	c.decode(d, &x)
	return x
}

func (c CollectionPvtReadWriteSet_codec) decode(d *codecapi.Decoder, x *CollectionPvtReadWriteSet) {
	d.StartStruct()
	for {
		n := d.NextStructField()
		if n < 0 {
...
func init() {
	codecapi.Register(CollectionPvtReadWriteSet{}, CollectionPvtReadWriteSet_codec{})
	codecapi.Register(&CollectionPvtReadWriteSet{}, ptr_CollectionPvtReadWriteSet_codec{})
}
