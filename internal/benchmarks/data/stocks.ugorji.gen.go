...
const (
	// ----- content types ----
	codecSelferCcUTF88731 = 1
	codecSelferCcRAW8731  = 255
	// ----- value types used ----
	codecSelferValueTypeArray8731     = 10
	codecSelferValueTypeMap8731       = 9
	codecSelferValueTypeString8731    = 6
	codecSelferValueTypeInt8731       = 2
	codecSelferValueTypeUint8731      = 3
	codecSelferValueTypeFloat8731     = 4
	codecSelferValueTypeNil8731       = 1
	codecSelferBitsize8731            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil8731 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct8731 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer8731 struct{}

func codecSelfer8731False() bool { return false }
func codecSelfer8731True() bool  { return true }
...
func (x *StockData) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil8731 {
		*(x) = StockData{}
	} else if yyct2 == codecSelferValueTypeMap8731 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray8731 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct8731)
	}
}
...
func (x codecSelfer8731) encSliceInterval(v []Interval, e *codec1978.Encoder) {
	var h codecSelfer8731
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8731) decSliceInterval(v *[]Interval, d *codec1978.Decoder) {
	var h codecSelfer8731
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
